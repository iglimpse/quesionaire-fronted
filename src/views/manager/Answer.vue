<template>
  <div>
    <div class="search">
      ...
      <el-input placeholder="请输入问卷id查询" style="width: 200px; margin-right: 10px" v-model="pageId"></el-input>
      <el-input placeholder="请输入题目名称查询" style="width: 200px; margin-right: 10px" v-model="questionName"></el-input>
      <el-input placeholder="请输入题目id查询" style="width: 200px; margin-right: 10px" v-model="questionId"></el-input>
